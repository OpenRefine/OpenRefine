 ...
 */
  ...
  function getAll (context, tag) {
    var elems; var elem
    var i = 0
    var found = typeof context.getElementsByTagName !== strundefined ? context.getElementsByTagName(tag || '*')
 ...
 */
  ...
  function getWidthOrHeight (elem, name, extra) {
    ...
    var isBorderBox = support.boxSizing && jQuery.css(elem, 'boxSizing', false, styles) === 'border-box'
