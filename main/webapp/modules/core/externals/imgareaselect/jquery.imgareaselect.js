...
(function ($) {
  ...
  $.imgAreaSelect = function (img, options) {
    ...
    var $box = div()
    var $area = div()
    var $border = div().add(div()).add(div()).add(div())
    var $outer = div().add(div()).add(div()).add(div())
    var $handles = $([])
    ...
    var minWidth; var minHeight; var maxWidth; var maxHeight
    ...
    var $p; var d; var i; var o; var w; var h; var adjusted
    ...
    function getSelection (noScale) {
      var sx = noScale || scaleX; var sy = noScale || scaleY
    ...
    function areaMouseMove (event) {
      ...
      var y = selY(evY(event)) - selection.y1
    ...
    function docMouseUp (event) {
      ...
      if (options.autoHide || selection.width * selection.height == 0) { hide($box.add($outer), function () { $(this).hide() }) }
    ...
    var docKeyPress = function (event) {
      var k = options.keys; var d; var t; var key = event.keyCode
