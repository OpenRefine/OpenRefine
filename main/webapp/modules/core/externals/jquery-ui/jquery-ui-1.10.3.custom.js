...
(function ($, undefined) {
  ...
  $.fn.extend({
    ...
    zIndex: function (zIndex) {
      ...
      if (this.length) {
        var elem = $(this[0]); var position; var value
...
(function ($, undefined) {
  ...
  $.widget = function (name, base, prototype) {
    var fullName; var existingConstructor; var constructor; var basePrototype
...
(function ($, undefined) {
  ...
  $.ui.plugin.add('draggable', 'connectToSortable', {
    start: function (event, ui) {
      var inst = $(this).data('ui-draggable'); var o = inst.options
    ...
    drag: function (event, ui) {
      var inst = $(this).data('ui-draggable'); var that = this
  ...
  $.ui.plugin.add('draggable', 'cursor', {
    start: function () {
      var t = $('body'); var o = $(this).data('ui-draggable').options
      if (t.css('cursor')) {
  ...
  $.ui.plugin.add('draggable', 'opacity', {
    start: function (event, ui) {
      var t = $(ui.helper); var o = $(this).data('ui-draggable').options
      if (t.css('opacity')) {
  ...
  $.ui.plugin.add('draggable', 'scroll', {
    ...
    drag: function (event) {
      var i = $(this).data('ui-draggable'); var o = i.options; var scrolled = false
...
(function ($, undefined) {
  ...
  $.ui.intersect = function (draggable, droppable, toleranceMode) {
    ...
    var draggableLeft; var draggableTop
    var x1 = (draggable.positionAbs || draggable.position.absolute).left; var x2 = x1 + draggable.helperProportions.width
    var y1 = (draggable.positionAbs || draggable.position.absolute).top; var y2 = y1 + draggable.helperProportions.height
    var l = droppable.offset.left; var r = l + droppable.proportions.width
    var t = droppable.offset.top; var b = t + droppable.proportions.height
...
(function ($, undefined) {
  ...
  $.widget('ui.resizable', $.ui.mouse, {
    ...
    _create: function () {
      var n; var i; var handle; var axis; var hname
      var that = this
      var o = this.options
    ...
    _respectSize: function (data) {
      ...
      var a = this.axis
      var ismaxw = isNumber(data.width) && o.maxWidth && (o.maxWidth < data.width); var ismaxh = isNumber(data.height) && o.maxHeight && (o.maxHeight < data.height)
      var isminw = isNumber(data.width) && o.minWidth && (o.minWidth > data.width); var isminh = isNumber(data.height) && o.minHeight && (o.minHeight > data.height)
    ...
    _proportionallyResize: function () {
      ...
      var i; var j; var borders; var paddings; var prel
 ...
 */
  ...
  $.ui.plugin.add('resizable', 'containment', {
    ...
    resize: function (event) {
      ...
      var that = $(this).data('ui-resizable')
      var o = that.options
      var co = that.containerOffset; var cp = that.position
      var pRatio = that._aspectRatio || event.shiftKey
      var cop = { top: 0, left: 0 }; var ce = that.containerElement
    ...
    resize: function (event, ui) {
      ...
      var _alsoResize = function (exp, c) {
        $(exp).each(function () {
          ...
          var css = c && c.length ? c : el.parents(ui.originalElement[0]).length ? ['width', 'height'] : ['width', 'height', 'top', 'left']
  ...
  $.ui.plugin.add('resizable', 'ghost', {
    ...
    start: function () {
      var that = $(this).data('ui-resizable'); var o = that.options; var cs = that.size
...
/* jshint loopfunc: true */
  ...
  $.widget('ui.sortable', $.ui.mouse, {
    ...
    _contactContainers: function (event) {
      var i; var j; var dist; var itemWithLeastDistance; var posProperty; var sizeProperty; var base; var cur; var nearBottom; var floating
    ...
    _generatePosition: function (event) {
      ...
      var pageX = event.pageX
      var pageY = event.pageY
      var scroll = this.cssPosition === 'absolute' && !(this.scrollParent[0] !== document && $.contains(this.scrollParent[0], this.offsetParent[0])) ? this.offsetParent : this.scrollParent; var scrollIsRootNode = (/(html|body)/i).test(scroll[0].tagName)
...
(function ($, undefined) {
  var lastActive; var startXPos; var startYPos; var clickDragged
...
(function ($, undefined) {
  $.widget('ui.menu', {
    ...
    _keydown: function (event) {
      ...
      var match; var prev; var character; var skip; var regex
...
(function ($) {
  ...
  $.widget('ui.tooltip', {
    ...
    _open: function (event, target, content) {
      var tooltip; var events; var delayedShow
...
(function ($, undefined) {
  ...
  $.effects.effect.blind = function (o, done) {
    ...
    var animation = {}
    var show = mode === 'show'
    var wrapper; var distance; var margin
...
(function ($, undefined) {
  $.effects.effect.clip = function (o, done) {
    ...
    var animation = {}
    var wrapper; var animate; var distance
...
(function ($, undefined) {
  $.effects.effect.pulsate = function (o, done) {
    ...
    var anims = ((o.times || 5) * 2) + (showhide ? 1 : 0)
...
(function ($, undefined) {
  ...
  $.effects.effect.size = function (o, done) {
    // Create element
    var original; var baseline; var factor
    var el = $(this)
