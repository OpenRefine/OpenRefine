...
(function($) {
        $.fn.filterListSearch = function(text) {
            ...
            listElements.one("filterSearch", function( e, text ) {
                ...
                console.log("filterSearchExecute");
                e.stopPropagation();
            });

            /* FILTERPORTFOLIO: pass in a class to show, all others will be hidden */
            listElements.one("filterSearchList", function( e, classToShow ) {
                if( text == ''){
                        return
                }else{
                    ...
                    e.stopPropagation();
                    console.log("filterSearchListExecute");
                }
            });
