Refine.SetLanguageUI = function(elmt) {
	...
	this._elmts.or_lang_label.text($.i18n_._('core-index-lang')["label"]+":");
	this._elmts.set_lan_btn.attr("value", $.i18n_._('core-index-lang')["send-req"]);
  ...
  $.ajax({
	...
	this._elmts.set_lan_btn.bind('click', function(e) {		
		$.ajax({
			...
			success : function(data) {
				alert($.i18n_._('core-index-lang')["page-reload"]);
...
Refine.actionAreas.push({
	id : "lang-settings",
	label : $.i18n_._('core-index-lang')["lang-settings"],
