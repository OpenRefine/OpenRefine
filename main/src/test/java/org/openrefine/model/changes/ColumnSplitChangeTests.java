...
public class ColumnSplitChangeTests extends ColumnChangeTestBase {
	...
	public void testDoesNotExist() throws DoesNotApplyException {
		Change SUT = new ColumnSplitChange("does_not_exist", Mode.Lengths, null, null, null, new int[] { 1, 2 }, EngineConfig.ALL_ROWS, false, false);
	...
	public void testLengths() throws DoesNotApplyException {
		Change SUT = new ColumnSplitChange("hello", Mode.Lengths, null, false, null, new int[] { 1, 2 }, EngineConfig.ALL_ROWS, false, false);
		GridState result = SUT.apply(toSplit);
