            ...
            if (args[0] instanceof String && args[1] instanceof String[] && (args[2] instanceof String[] || args[2] instanceof String)) {
                ...
                if (search.length >= replace.length) {
                    ...
                    return new EvalError(ControlFunctionRegistry.getFunctionName(this)
                            + ": the number of replacements must be equal to or less than the number of search strings.");
                }
            }
        }
        return new EvalError(ControlFunctionRegistry.getFunctionName(this)
                + " expects 3 arguments: string, array of strings to replace, array of replacement strings");
    }
