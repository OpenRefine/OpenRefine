...
public class ParquetImporter extends TabularImportingParserBase {
    ...
    public ObjectNode createParserUIInitializationData(
        ...
        JSONUtilities.safePut(options, "encoding", "utf-8");
        return options;
    }
    ...
    public void parseOneFile(
        ...
        try {
            ParquetMetadata parquetMetadata = ParquetReader.readMetadata(new File(fileSource));
            ...
            Iterator<List<Object>> it = ParquetReader.streamContent(new File(fileSource), HydratorSupplier.constantly(hydrator)).iterator();
