 ...
 * facet (the ones selected by all other active facets) - the histogram for all rows, which is used to determine the bin
 * size. This is added to ensure that the bin size does not change when interactively faceting.
 * 
...
public class NumericFacetState implements FacetState {
     ...
     * with the supplied log bin size.
     * 
     * @return
     */
