...
/**
 * Represents a file to import in an importing job. Multiple files
 * can be imported to form the same project.
 * 
...
public class ImportingFileRecord {
	...
	/**
	 * Returns a string which represents where the file came from
	 * (URL, spark URI or filename).
	 */
	@JsonIgnore
	...
	/**
	 * Returns a path to the file stored in the raw data directory
	 * corresponding to this file record.
	 * This is not applicable to file records pointing to a Spark URI.
	 * 
	 * @param rawDataDir
	...
	/**
	 * Returns either a path to the locally stored file or the remote Spark URI,
	 * to read the file from a Spark-based importer.
	 * @param rawDataDir
	 * 	   the directory where the files pertaining to the corresponding importing
	 *     job are stored.
	 */
