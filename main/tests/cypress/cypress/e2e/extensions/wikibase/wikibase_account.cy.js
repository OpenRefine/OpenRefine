describe(__filename, function () {
  it('Test the elements of the login panel', function () {
    ...
    cy.get('.dialog-container .dialog-header').should('to.contain', 'Wikidata account');
  ...
  it('Login with invalid credentials', function () {
    ...
    cy.get('.dialog-container .wikibase-invalid-credentials').should('be.visible');
  });
  ...
  it('Login with owner only consumer credentials (invalid credentials)', function () {
    ...
    cy.get('.dialog-container a').contains('login with your owner-only consumer').click();
    ...
    cy.get('.dialog-container a').contains('login with your username/password').click();
    cy.get('.dialog-container input#wb-username').should('be.visible');
  });
});
