describe(__filename, function () {
  ...
  it('Export a project through "Tab-separated value"', function () {
    ...
    cy.get('#export-button').click();
    triggerLoadEvent();
    cy.get('.menu-container a').contains('Tab-separated value').click();
    cy.get('.app-path-section')
      .invoke('text')
      .then((name) => {
  ...
  it('Export a project through "Comma-separated value"', function () {
    ...
    cy.get('#export-button').click();
    triggerLoadEvent();
    cy.get('.menu-container a').contains('Comma-separated value').click();
    cy.get('.app-path-section')
      .invoke('text')
      .then((name) => {
  ...
  it('Export a project through "HTML table"', function () {
    ...
    cy.get('#export-button').click();
    triggerLoadEvent();
    cy.get('.menu-container a').contains('HTML table').click();
  ...
  it('Export a project through "Excel (.xls)"', function () {
    ...
    cy.get('#export-button').click();
    triggerLoadEvent();
    cy.get('.menu-container a').contains('Excel (.xls)').click();
  ...
  it('Test cell value too long error for export to XLS format', function () {
    const TALL_FIXTURE = [['column'], ['cell value too long'.padEnd(32768, '.')]];
  ...
  it('Export a project through "Excel 2007+ (.xlsx)"', function () {
    ...
    cy.get('#export-button').click();
    triggerLoadEvent();
    cy.get('.menu-container a').contains('Excel 2007+ (.xlsx)').click();
  ...
  it('Export a project through "ODF spreadsheet"', function () {
    ...
    cy.get('#export-button').click();
    triggerLoadEvent();
    cy.get('.menu-container a').contains('ODF spreadsheet').click();
  ...
  it('Export a project through "Custom tabular exporter"', function () {
    ...
    cy.get('#export-button').click();
    cy.get('.menu-container a').contains('Custom tabular').click();
  ...
  it('Export a project through "SQL Exporter"', function () {
    ...
    cy.get('#export-button').click();
    cy.get('.menu-container a').contains('SQL').click();
    cy.get('a[bind="or_dialog_download"]').click();
    triggerLoadEvent();
    cy.get('button[bind="downloadButton"]').click();
  ...
  it('Export a project through "Templating"', function () {
    ...
    cy.get('#export-button').click();
    cy.get('.menu-container a').contains('Templating').click();
