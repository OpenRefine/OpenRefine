describe('Discard reconciliation judgments', () => {
  ...
  it('Test discard existing reconciliation judgments', () => {
    ...
    cy.columnActionClick('species', ['Reconcile', 'Actions', 'Discard reconciliation judgments']);
    ...
    cy.get('table.data-table td .data-table-cell-content').should('not.to.contain', 'Choose new match');
  });
});
