describe(__filename, function () {
  it('Ensure text conversion to Uppercase', function () {
    ...
    cy.columnActionClick('Shrt_Desc', ['Edit cells', 'Common transforms', 'To uppercase']);

    // Check notification and cell content
    cy.assertNotificationContainingText('Text transform on 0 cells in column Shrt_Desc: value.toUppercase()');
