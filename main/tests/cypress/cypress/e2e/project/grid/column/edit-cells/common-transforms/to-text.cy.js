describe(__filename, function () {
  it('Ensure number is converted to text', function () {
    ...
    cy.columnActionClick('NDB_No', ['Edit cells', 'Common transforms', 'To text']);

    // Check notification and cell content
    cy.assertNotificationContainingText('Text transform on 2 cells in column NDB_No: value.toString()');
