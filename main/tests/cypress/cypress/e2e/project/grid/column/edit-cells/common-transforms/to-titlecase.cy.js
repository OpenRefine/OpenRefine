describe(__filename, function () {
  it('Ensure text conversion to titlecase', function () {
    ...
    cy.columnActionClick('Shrt_Desc', ['Edit cells', 'Common transforms', 'To titlecase']);

    // Check notification and cell content
    cy.assertNotificationContainingText('Text transform on 2 cells in column Shrt_Desc: value.toTitlecase() ');
