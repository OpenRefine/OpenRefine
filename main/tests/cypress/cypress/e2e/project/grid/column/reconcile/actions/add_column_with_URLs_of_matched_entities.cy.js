describe('Add column with URLs of matched entities', () => {
  ...
  it('Add column with URLs of matched entities', () => {
    ...
    cy.columnActionClick('Item', ['Reconcile', 'Add column with URLs of matched entities']);

    // check the dialog, enter a new column name "id_column"
    cy.get('.dialog-container .dialog-header').should('to.contain', 'Add column with URLs of matched entities');
