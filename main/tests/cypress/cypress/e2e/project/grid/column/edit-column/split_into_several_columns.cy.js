describe(__filename, function () {
  it('Ensures column is splitted by comma seperator', function () {
    ...
    cy.get('th:nth-child(3) > div.column-header-title > .column-header-name').should('to.contain', 'Shrt_Desc 1');
    cy.get('th:nth-child(4) > div.column-header-title > .column-header-name').should('to.contain', 'Shrt_Desc 2');
    cy.get('th:nth-child(5) > div.column-header-title > .column-header-name').should('to.contain', 'Shrt_Desc 3');
  ...
  it('Ensures column is splitted by comma seperator without removing original column', function () {
    ...
    cy.get('th:nth-child(3) > div.column-header-title > .column-header-name').should('to.contain', 'Shrt_Desc');
    cy.get('th:nth-child(5) > div.column-header-title > .column-header-name').should('to.contain', 'Shrt_Desc 2');
    cy.get('th:nth-child(6) > div.column-header-title > .column-header-name').should('to.contain', 'Shrt_Desc 3');
  ...
  it('Ensures column is splitted by field-lengths seperator without removing original column', function () {
    ...
    cy.get('th:nth-child(5) > div.column-header-title > .column-header-name').should('to.contain', 'Shrt_Desc 2');
    cy.get('th:nth-child(6) > div.column-header-title > .column-header-name').should('to.contain', 'Shrt_Desc 3');
    cy.get('th:nth-child(7) > div.column-header-title > .column-header-name').should('to.contain', 'Shrt_Desc 4');
