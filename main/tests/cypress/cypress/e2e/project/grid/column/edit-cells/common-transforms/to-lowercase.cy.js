describe(__filename, function () {
  it('Ensure values in cells are converted to lowercase', function () {
    ...
    cy.columnActionClick('Shrt_Desc', ['Edit cells', 'Common transforms', 'To lowercase']);

    // Check notification and cell content
    cy.assertNotificationContainingText('Text transform on 2 cells in column Shrt_Desc: value.toLowercase()');
