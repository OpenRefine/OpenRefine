describe('Clear reconciliation data', () => {
  ...
  it('Test clearing reconciliation for a reconciled dataset', () => {
    ...
    cy.columnActionClick('species', ['Reconcile', 'Actions', 'Clear reconciliation data']);
    ...
    cy.get('table.data-table thead div.column-header-recon-stats-matched').should('not.be.visible');
  });
});
