describe('Match each cell to its best candidate', () => {
  ...
  it('Match each cell to its best candidate', () => {
    ...
    // Match all
    cy.columnActionClick('species', ['Reconcile', 'Actions', 'Match each cell to its best candidate']);

    cy.assertNotificationContainingText('Match each of 6 cells to its best candidate');
