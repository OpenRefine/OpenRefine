describe(__filename, function () {
  it('Ensure all rows are starred', function () {
    ...
    cy.get('.data-table tr:nth-child(1) td:nth-child(1) a').should('have.class', 'data-table-star-on');
    cy.get('.data-table tr:nth-child(2) td:nth-child(1) a').should('have.class', 'data-table-star-on');
  });
  it('Ensure all rows are unstarred', function () {
    ...
    cy.get('.data-table tr:nth-child(1) td:nth-child(1) a').should('have.class', 'data-table-star-off');
    cy.get('.data-table tr:nth-child(2) td:nth-child(1) a').should('have.class', 'data-table-star-off');
  });
  it('Ensure all rows are flagged', function () {
    ...
    cy.get('.data-table tr:nth-child(1) td:nth-child(2) a').should('have.class', 'data-table-flag-on');
    cy.get('.data-table tr:nth-child(2) td:nth-child(2) a').should('have.class', 'data-table-flag-on');
  });
  it('Ensure all rows are unflagged', function () {
    ...
    cy.get('.data-table tr:nth-child(1) td:nth-child(2) a').should('have.class', 'data-table-flag-off');
    cy.get('.data-table tr:nth-child(2) td:nth-child(2) a').should('have.class', 'data-table-flag-off');
  });
