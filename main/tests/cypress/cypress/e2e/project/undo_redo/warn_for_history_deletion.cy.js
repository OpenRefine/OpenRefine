describe(__filename, function () {
  it('Apply an operation after changes have been undone', function () {
    ...
    cy.get('.history-panel-body .history-past a.history-entry:first-of-type').click();
    cy.get('.history-panel-body .history-now').should('to.contain', 'Create project');
    cy.get('.history-panel-body .history-future').should('to.contain', 'Remove column NDB_No');
    ...
    cy.getCell(1, 'Shrt_Desc').find('button.data-table-cell-edit').click();
