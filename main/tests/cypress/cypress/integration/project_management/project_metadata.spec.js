describe(__filename, function () {
  ...
  it('Ensures project-metadata has correct details', function () {
    ...
    cy.navigateTo('Open Project');
    cy.contains('td', projectName).siblings().contains('a', 'About').click();
    cy.get('#metadata-body table>tr').eq(3).contains('Project name');
    cy.get('#metadata-body table>tr').eq(3).contains(projectName);
  });
  it('Ensures project-metadata can be edit project name', function () {
    ...
    cy.contains('td', 'Project name:')
      ...
      .click();
    cy.get('#metadata-body table>tr').eq(3).contains('Project name');
    cy.get('#metadata-body table>tr').eq(3).contains('testProject');
  });
  it('Ensures project-metadata can be edit tags', function () {
    ...
    cy.get('#metadata-body table>tr').eq(4).contains('Tags');
    cy.get('#metadata-body table>tr').eq(4).contains('tagTest');
  });
  it('Ensures project-metadata can be edit creator', function () {
    ...
    cy.get('#metadata-body table>tr').eq(5).contains('Creator');
    cy.get('#metadata-body table>tr').eq(5).contains('testCreator');
  });
  it('Ensures project-metadata can be edit contributors', function () {
    ...
    cy.contains('td', 'Contributors:')
      ...
      .contains('button', 'Edit')
      .click();
    cy.get('#metadata-body table>tr').eq(6).contains('Contributors');
    cy.get('#metadata-body table>tr').eq(6).contains('testcontributor');
  });
  it('Ensures project-metadata can be edit subject', function () {
    ...
    cy.get('#metadata-body table>tr').eq(7).contains('Subject');
    cy.get('#metadata-body table>tr').eq(7).contains('testSubject');
  });
  it('Ensures project-metadata can be edit license', function () {
    ...
    cy.get('#metadata-body table>tr').eq(12).contains('License');
    cy.get('#metadata-body table>tr').eq(12).contains('GPL-3');
  });
  it('Ensures project-metadata can be edit homepage', function () {
    ...
    cy.contains('td', 'Homepage:')
      ...
      .contains('button', 'Edit')
      .click();
    cy.get('#metadata-body table>tr').eq(13).contains('Homepage');
    cy.get('#metadata-body table>tr').eq(13).contains('openrefine.org');
  });
});
