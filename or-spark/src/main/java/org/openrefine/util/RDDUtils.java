...
public class RDDUtils {
    ...
    /**
     * Performs a limit: returns a new RDD which contains the n first elements of this
     * RDD. The supplied RDD is assumed to be keyed by indices, and the resulting RDD
     * will be more efficient if the original RDD is partitioned by key.
     * 
     * @param <V>
     * @param pairRDD
     * @param limit
