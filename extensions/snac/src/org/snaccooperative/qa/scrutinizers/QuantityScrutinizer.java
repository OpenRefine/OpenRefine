            ...
            if(allowedUnits != null &&
                ...
                if (currentUnit != null) {
                    issue.setProperty("unit_entity",
                            // this is a hack but it will not be needed anymore in the upcoming version of SNAC-Toolkit
                            Datamodel.makeSNACItemIdValue(currentUnit.substring(currentUnit.indexOf("Q"))));
                }
                addIssue(issue);
            }
        }
