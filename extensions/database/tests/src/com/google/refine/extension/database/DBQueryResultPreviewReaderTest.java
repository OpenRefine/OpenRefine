...
public class DBQueryResultPreviewReaderTest {
    ...
    public void testGettingColumnNamesAsHeader() throws IOException {
        ...
        DBQueryResultPreviewReader reader = new DBQueryResultPreviewReader(job, dbService, querySource, columns, dbQueryInfo, 10);
    ...
    public void testLoadingAllBatches(final int tableCount, final int batchSize) throws IOException, DatabaseServiceException {
        ...
        DBQueryResultPreviewReader reader = new DBQueryResultPreviewReader(job, dbService, querySource, columns, dbQueryInfo, batchSize);
