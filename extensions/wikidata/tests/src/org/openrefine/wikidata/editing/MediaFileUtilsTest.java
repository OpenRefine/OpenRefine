...
public class MediaFileUtilsTest {
	...
	public void testSuccessfulLocalUpload() throws IOException, MediaWikiApiErrorException {
		...
		MediaUploadResponse response = mediaFileUtils.uploadLocalFile(path, "My_test_file.png", "my wikitext", "my summary", Collections.emptyList());
	...
	public void testSuccessfulRemoteUpload() throws IOException, MediaWikiApiErrorException {
		...
		MediaUploadResponse response = mediaFileUtils.uploadRemoteFile(new URL(url), "My_test_file.png", "my wikitext", "my summary", Collections.emptyList());
	...
	public void testGetMidFromFilename() throws IOException, MediaWikiApiErrorException {
		...
		MediaUploadResponse response = ParsingUtilities.mapper.readValue("{\"result\":\"Success\",\"filename\":\"Commons-logo.svg\"}", MediaUploadResponse.class);
