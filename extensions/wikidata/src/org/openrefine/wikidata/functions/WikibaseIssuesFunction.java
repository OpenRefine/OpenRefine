...
/**
 * GREL function which computes the "aggregation identifiers" of the issues found on the edits generated by
 * a given row. Those "aggregation identifiers" are used to group issues together (increasing their number
 * of occurrences and reporting them only once to the user).
 * 
 * This GREL function is primarily meant to be used in facets, to select rows which generate a particular 
 * issue, with expressions of the form: grel:wikibaseIssues().inArray('duplicate-whitespace')
 * 
