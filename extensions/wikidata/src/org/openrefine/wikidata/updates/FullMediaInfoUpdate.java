...
/**
 * An extension of WDTK's {@link MediaInfoUpdate} which also
 * lets us change the file name of a file and/or replace its contents.
 * 
...
public class FullMediaInfoUpdate extends MediaInfoUpdateImpl implements MediaInfoUpdate {
	 ...
	 * @param filePath
	 *          if not null, the path or URL to the file to use to replace
	...
	/**
	 * If not null, the path or URL to the file which should replace the media contents
	 * of this entity.
	 * If null, the contents of the entity are left untouched.
	 */
	@JsonIgnore
	 ...
	 * If null, the filename is left untouched.
	 */
	@JsonIgnore
	 ...
	 * If null, the wikitext is left untouched.
	 * @return
	 */
	@JsonIgnore
