...
/**
 * Wikidata-Toolkit's StatementGroup class is not designed to be serialized, so its serialization via Jackson is not
 * specified. This adds annotations to specify its behaviour.
 * 
