...
public enum StatementEditingMode {
	/**
	 * If there are no matching statements on the item, add
	 * our statement. Otherwise, leave the item unchanged.
	 */
	@JsonProperty("add")
	ADD,
	/**
	 * If there are no matching statements on the item, add
	 * our statement. Otherwise, merge our statement with the
	 * first matching one.
	 */
