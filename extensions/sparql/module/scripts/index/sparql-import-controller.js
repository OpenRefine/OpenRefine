...
Refine.SPARQLImportController.prototype.startImportJob = function(form, progressMessage, callback) {
  var self = this;
...
Refine.SPARQLImportController = function(createProjectUI) {
  ...
  for (var i = 0; i < Refine.SPARQLImportController.sources.length; i++) {
    var sourceSelectionUI = Refine.SPARQLImportController.sources[i];
...
Refine.SPARQLImportController.sources = [];
Refine.SPARQLImportController.parserUIs = {};

Refine.SPARQLImportController.prototype._startOver = function() {
  if (this._jobID) {
...
Refine.SPARQLImportController.prototype._prepareData = function() {
  var extensionMap = {};
  var extensionList = [];
...
Refine.SPARQLImportController.prototype._ensureFormatParserUIHasInitializationData = function(format, onDone) {
...
Refine.SPARQLImportController.prototype.updateFormatAndOptions = function(options, callback, finallyCallBack) {
  var self = this;
  Refine.wrapCSRF(function(token) {
    $.post(
      "command/core/importing-controller?" + $.param({
...
Refine.SPARQLImportController.prototype.getPreviewData = function(callback, numRows) {
  var self = this;
  var result = {};
...
Refine.SPARQLImportController.prototype._createProject = function() {
