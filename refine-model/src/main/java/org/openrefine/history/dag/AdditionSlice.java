...
public class AdditionSlice implements DagSlice {
    ...
    public AdditionSlice(
            ...
            @JsonProperty("outputs") List<ColumnMetadata> outputColumns,
            @JsonProperty("position") int insertionPosition) {
    ...
    /**
     * @return the set of column names this slice depends on
     */
    @JsonProperty("inputs")
    ...
    /**
     * @return the list of columns created by the operation, in the insertion order
     */
    ...
    /**
     * @return the position in the list of columns where new columns are inserted
     */
    ...
    public boolean equals(Object other) {
        ...
        return (inputColumns.equals(otherSlice.getInputColumns()) &&
