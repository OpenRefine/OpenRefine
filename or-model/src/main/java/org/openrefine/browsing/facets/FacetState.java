 ...
 * It is required to be serializable to JSON via Jackson to be 
 * returned to the frontend to display facet statistics.
 * 
...
public interface FacetState extends Serializable {
	/**
	 * @return
	 *     the facet this came state corresponds to
	 */
	@JsonIgnore
	public Facet getFacet();
	
	/**
	 * Convenience method to return the row filter
	 * corresponding to this facet.
	 */
	@JsonIgnore
	...
	/**
	 * Convenience method to return the record filter
	 * corresponding to this facet.
	 */
	@JsonIgnore
	...
	/**
	 * Merges two facet statistics from the same facet,
	 * computed on different sets of rows. This generally
	 * amounts to summing all the statistics internally.
	 *
	 * @param other
	 *     the other facet statistics to add to the current instance.
	 *     It is required to stem from the same facet as the current instance.
	 * @return
	 ...
	 * Given that facet states are expected to be immutable, this returns
	 * a new facet state object
	 * 
	 * @param record
	 ...
	 * @return
	 *       the facet state updated with this record
	 */
