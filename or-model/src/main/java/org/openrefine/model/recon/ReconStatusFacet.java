...
/**
 * Facet provided to compute reconciliation statistics via the {@link GridState}
 * API - this facet is not actually exposed to end users at the moment (a text facet
 * is used instead).
 */
