...
/**
 * A function applied to a record, returning
 * a list of rows to replace it. They do not 
 * need to form a single record.
 * 
...
public interface RecordMapper extends Serializable {
    ...
    /**
     * If every record is mapped to a list with the
     * same number of rows as what the record contains,
     * set this boolean to true. This helps the underlying
     * implementation avoid recomputing row ids.
     */
    ...
    /**
     * Returns a mapper which applies one of the two mappers provided depending
