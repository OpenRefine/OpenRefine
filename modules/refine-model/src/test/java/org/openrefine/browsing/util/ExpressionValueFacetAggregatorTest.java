...
public class ExpressionValueFacetAggregatorTest {
    ...
    public void testAggregateArray() {
        ...
        // If we enforce this in the Cell class, this test should be adapted to just make the evaluator return an array
        // instead
        DummyState state = SUT.withRow(new DummyState(), 1234L,
                new Row(Collections.singletonList(new Cell(new Object[] { "foo", 12345L }, null))));
