 ...
 * </ul>
 * When
 * {@link #retrieveOrCompute(ChangeDataId, ChangeDataSerializer, Grid, Function, String, History, int, org.openrefine.browsing.Engine.Mode)}
 * finds an incomplete change data is found in the base directory, it is moved to the incomplete directory. A new
 * version of the change data, completed using the completion process, is then saved again in the base directory.
 */
