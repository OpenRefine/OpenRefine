...
public interface RowFlatMapper extends Serializable {
    ...
    /**
     * Returns a flat mapper which applies one of the two mappers provided depending on the outcome of the filter. If
     * the filter evaluates to true, the positive mapper is evaluated, otherwise the negative one is used.
     * 
     * @param filter
