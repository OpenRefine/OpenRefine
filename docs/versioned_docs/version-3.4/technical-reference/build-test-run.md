...
* [Java JDK](http://java.sun.com/javase/downloads/index.jsp) (Get [OpenJDK from here](https://jdk.java.net/archive/). At the moment you cannot use JDK > 14.0.2, see [Issue on Github](https://github.com/OpenRefine/OpenRefine/issues/4106).)
