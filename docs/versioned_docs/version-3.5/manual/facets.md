...
You can learn about facets and filtering with the following example. You can copy the following table and paste it using the <span class="menuItems">Clipboard</span> method of starting a project if you would like to try it yourself. Check the "Attempt to parse cell text into numbers" option so that we can use numeric faceting.
