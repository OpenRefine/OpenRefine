...
###### splitByLengths(s, n1, n2, ...) [(optional) i1, i2] {#splitbylengthss-n1-n2-}
...
Optionally, it also allows array slicing on the returned array. In this case it returns the array consisting of a subset of elements between i1 and (i2 – 1)
For example,
