...
Returns the inputted date as a string in any valid format to a date object in the [ISO 8601 extended format](exploring#data-types) (converted to UTC). For example, "October 4th, 2021" returns [date 2021-10-04T00:00:00Z]. Generally, date formats supported by this function are stated [here](https://github.com/sisyphsu/dateparser#showcase).
