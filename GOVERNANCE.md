...
Use of any official OpenRefine accounts (social media, funding, banking, code repository, website, domain, etc.) for the purpose of promotion of another entity must always be discussed prior with the Advisory committee or optionally Steering committee.

Any language used through official accounts that gives the impression that the OpenRefine organization approves, authorizes or otherwise supports a project, person, or company is not permissible without authorization from the Advisory Committee or optionally Steering committee.

## Funding
Decisions on funding must first be coordinated in the Advisory committee.
Starting new crowdfunding campaigns, funding applications or other partnerships in the name of the project should first be coordinated in the Advisory committee.
