...
To do so, click on the first item in [this page](https://github.com/OpenRefine/OpenRefine/actions/workflows/snapshot_release.yml) and
scroll down to find the version that matches your operating system.
